...
public:
	...
	virtual Dialog*			NewDialog(int theDialogId, bool isModal, const PopWorkString& theDialogHeader, const PopWorkString& theDialogLines, const PopWorkString& theDialogFooter, int theButtonMode);		
	...
	virtual void			HandleNotifyGameMessage(int theType, int theParam); // for HWND_BROADCAST of mNotifyGameMessage (0-1000 are reserved for AppBase for theType)
	...
	virtual Dialog*			DoDialog(int theDialogId, bool isModal, const PopWorkString& theDialogHeader, const PopWorkString& theDialogLines, const PopWorkString& theDialogFooter, int theButtonMode);
