...
public:
	Dialog(Image* theComponentImage, Image* theButtonComponentImage, 
		int theId, bool isModal, const PopWorkString& theDialogHeader, const PopWorkString& theDialogLines, const PopWorkString& theDialogFooter, int theButtonMode); //UNICODE
