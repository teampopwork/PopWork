...
public:
	...
	virtual Rect			WriteCenteredLine(Graphics* g, int anOffset, const PopWorkString& theLine, Color theColor1, Color theColor2, const Point& theShadowOffset = Point(1,2));

	virtual int				WriteString(Graphics* g, const PopWorkString& theString, int theX, int theY, int theWidth = -1, int theJustification = -1, bool drawString = true, int theOffset = 0, int theLength = -1);
	virtual int				WriteWordWrapped(Graphics* g, const Rect& theRect, const PopWorkString& theLine, int theLineSpacing, int theJustification);
