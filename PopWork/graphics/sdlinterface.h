...
// 0x0008
	...
	public:
		...
		void BltTransformed(Image* theImage, const Rect* theClipRect, const Color& theColor, int theDrawMode, const Rect& theSrcRect, const PopWorkMatrix3& theTransform, bool linearFilter, float theX = 0, float theY = 0, bool center = false);
