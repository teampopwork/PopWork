...
PopWork::Font* Graphics::GetFont()
{
	return mFont;
}

void Graphics::SetFont(PopWork::Font* theFont)
{
	mFont = theFont;
}
...
void Graphics::DrawImage(PopWork::Image* theImage, int theX, int theY)
{
...
void Graphics::DrawImageMatrix(Image* theImage, const PopWorkMatrix3 &theMatrix, const Rect &theSrcRect, float x, float y)
{
...
int Graphics::WriteString(const PopWorkString& theString, int theX, int theY, int theWidth, int theJustification, bool drawString, int theOffset, int theLength, int theOldColor)
{
	Font* aFont = GetFont();
	if (theOldColor==-1)
...
static int WriteWordWrappedHelper(Graphics *g, const PopWorkString& theString, int theX, int theY, int theWidth, int theJustification, bool drawString, int theOffset, int theLength, int theOldColor, int theMaxChars)
{
...
int	Graphics::WriteWordWrapped(const Rect& theRect, const PopWorkString& theLine, int theLineSpacing, int theJustification, int *theMaxWidth, int theMaxChars, int *theLastWidth)
{
...
int	Graphics::DrawStringWordWrapped(const PopWorkString& theLine, int theX, int theY, int theWrapWidth, int theLineSpacing, int theJustification, int *theMaxWidth)
{
