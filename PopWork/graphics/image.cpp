...
void Image::BltMatrix(Image* theImage, float x, float y, const PopWorkMatrix3 &theMatrix, const Rect& theClipRect, const Color& theColor, int theDrawMode, const Rect &theSrcRect, bool blend)
{
}
