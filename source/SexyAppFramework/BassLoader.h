...
struct BASS_INSTANCE
{
	...
	BOOL(WINAPI * BASS_ChannelUpdate)(DWORD handle, DWORD length);
	BOOL(WINAPI *BASS_ChannelGetInfo)(DWORD handle, BASS_CHANNELINFO* info);
	...
	BOOL (WINAPI *BASS_SampleCreate)(DWORD length, DWORD freq, DWORD chans, DWORD max, DWORD flags);
	BOOL(WINAPI* BASS_StreamCreate)(DWORD freq, DWORD chans, DWORD flags, STREAMPROC* proc, void *user);
