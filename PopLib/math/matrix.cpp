...
double PopLib::Transform2D::determinantOfMinor(int theRowHeightY, int theColumnWidthX) const
{
...
double PopLib::Transform2D::GetDeterminant() const
{
	return (m[0][0] * determinantOfMinor(0, 0)) - (m[0][1] * determinantOfMinor(0, 1)) +
		   (m[0][2] * determinantOfMinor(0, 2));
}

PopLib::Transform2D PopLib::Transform2D::Inverse() const
{
