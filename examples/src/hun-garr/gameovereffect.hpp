...
//////////////////////////////////////////////////////////////////////////
#ifndef __GAME_OVER_EFFECT_HPP__
#define __GAME_OVER_EFFECT_HPP__
#ifdef _WIN32
#pragma once
#endif
...
class GameOverEffect
{
  ...
  private:
	...
	bool mCanInitFirstLevel; // When true, indicates that the board should set up the first level so that it'll be there
							 // when we fade out
