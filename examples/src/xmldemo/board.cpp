...
void Board::Draw(Graphics *g)
{
	...
	g->DrawString(
		StrFormat(_S("Section 1/BoolParam value: %s"), mApp->mSection1.mBoolParamElement ? _S("true") : _S("false")),
		10, 60);
	...
	g->DrawString(StrFormat(_S("Section 2/Subsection/Item2 value: %s"), mApp->mSection2.mSubsectionItem2.c_str()), 10,
				  210);
}
